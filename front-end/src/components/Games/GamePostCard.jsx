...
//         {/* Top - Post Title */}
//         <h1 className="text-lg font-bold mb-2 text-blue-400 truncate">
//           {post.title}
//         </h1>
...
//         {/* Bottom - Post Description + Footer */}
...
//             <button className="px-3 py-1 bg-orange-500 hover:bg-orange-400 rounded-md text-xs font-semibold">
//                Like
//             </button>
//           </div>
//         </div>
